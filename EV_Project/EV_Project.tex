...
\title{Personal Vehicle Value Loss, Electric vs.~Combustion}
...
You can insert references. Here is some text (Schloter 2022; Breetz and
Salon 2018) and see Zang, Wang, and Qi (2022), or Rapson and Muehlegger
(2023).
...
\begin{figure}
\centering
\includegraphics{EV_Project_files/figure-latex/fig2-1.pdf}
